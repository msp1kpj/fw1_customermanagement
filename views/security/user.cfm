	...
	<div class="container">
		<div class="row">
			...
			<ul class="breadcrumb">
				...
				<li><a class="tip-bottom" href="#buildURL( 'security.users' )#" data-original-title="Go to users">Users</a></li>
			</ul>
		</div>
		<div class="row-fluid">
			<div class="span8">
				#view( "helpers/messages" )#
				<form action="#buildURL( 'security.userSave' )#" method="post" class="form-horizontal " id="user-form">
					<fieldset class="block">
						...
						<div class="block-body">
							...
							<div class="control-group ">
								...
								<div class="controls">
									<input class="input-xxlarge" type="password" name="password" id="password" value="" maxlength="30"  placeholder="New Password" />
							...
							<div class="control-group ">
								...
								<div class="controls">
									<input class="input-xxlarge" type="password" name="passwordConfirm" id="passwordConfirm" value="" maxlength="30" placeholder="Confirm Password" />
								</div>
							</div>
						</div>
						<div class="form-actions">
							<input type="submit" name="submit" value="Save" class="btn btn-primary">
							<a href="#buildURL( 'security.users' )#" class="btn cancel">Cancel</a>
						</div>
					</fieldset>
